			...
			<div class="applyForm" action="ApplyFormAction.java">
				<table class="tb">
					...
					<tr class="tr1">
						...
						<td class="tbinput">
							<div class="period"><input type="text" class="gray" id="fromDate" > 
							~ <input type="text" class="gray" id="toDate" > </div>
						</td>
					</tr>
					<tr class="tr1">
						<td class="tbname">모집기간</td>
						<td class="tbinput">
							<div class="period"><input type="text" class="gray" id="recruiteFromDate" > 
							~ <input type="text" class="gray" id="recruiteToDate" > </div>
						</td>
					</tr>
					<tr class="tr1">
					...
					<tr class="tr1">
						...
						<td class="tbinput"><input type="text"
							class="form-control" placeholder="5,000" name="e_price" id="e_priceSmall" value="">
							<div class="checkBox"><input type="checkbox"  name="e_priceCheck" id="e_priceCheck" onClick="checkDisable(this.form)" > 무료</div></td>
					</tr>
					<tr class="tr1">
						<td class="tbname">행사대표이미지</td>
						<td class="tbinput" >
							<div class="goLeft"><img alt="image" src="" id="titleImage" width="30%">&nbsp&nbsp
							<input type="file"  class="form-select-sm" accept='image/*' onchange='openFile(event)'></div></td>
					</tr>
					<tr class="tr1">
						<td class="tbname">행사상세이미지</td>
						<td class="tbinput">
							<div class="goLeft"><img alt="image" src="" id="contentImage" width="30%">&nbsp&nbsp
							<input type="file" class="form-select-sm" accept='image/*' onchange='openFile2(event)'></div></td>
					</tr>
					<tr class="tr1">
